class ReportsController < ApplicationController
  ...
  def find_report
    ...
    if @report_name == 'Strength'
    ...
    elsif @report_name == 'Class Wise Activeness' && @student.nil?
    ...
    elsif @report_name == 'Class Wise Questions Comparison'
      ...
      @students_questions_compare_chart = GoogleChartService.render_reports_charts(@students_questions_compare_table, :bar, "Class wise questions asked by students", true, 'Name', 'Question Count',false)

    elsif @report_name == 'Class Wise Answers Comparison'
      ...
      @students_answers_compare_chart = GoogleChartService.render_reports_charts(@students_answers_compare_table, :bar, "Class wise answers given by students", true,'Name','Answers Count',false)
    end
  ...
  private
    ...
    def set_student
      @student  = Student.find_by_email(params[:email]) if params[:email].present?
    end
